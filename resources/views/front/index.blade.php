            ...
            <div class="tp-offcanvas-2-left left-box">
                <div class="tp-offcanvas-2-left-wrap d-flex justify-content-between align-items-center">
                    <div class="tp-offcanvas-2-logo">
                        <a href="index.html">
                            <img class="logo-1" data-width="140" src="{{ asset('assets/AIcontrol_imgs/mian_Icon/aicontrol-co-mau.svg') }}" alt="">
                            <img class="logo-2" data-width="140" src="{{ asset('assets/AIcontrol_imgs/mian_Icon/aicontrol-co-mau.svg') }}" alt="">
                        </a>
                    </div>
                        ...
                        <div class="tp-header-8-wrapper d-flex align-items-center justify-content-between">
                            ...
                            <div class="tp-header-8-middle">
                                <div class="tp-header-logo">
                                    <a href="index.html"><img data-width="250" src="{{ asset('assets/AIcontrol_imgs/mian_Icon/aicontrol-co-mau.svg') }}" alt=""></a>
                                </div>
                            </div>
        ...
        <nav class="tp-mobile-menu-active d-none">
            <ul>
                ...
                <li class="has-dropdown p-static is-active">
                    <a href="#">Giải pháp</a>
                    <ul class="tp-submenu submenu">
                        <li><a href="about-me-light.html">Điều khiển chiếu sáng</a></li>
                        <li><a href="about-us-light.html">Rèm cửa tự động </a></li>
                        <li><a href="service-1-light.html">Điều khiển HVAC</a></li>
                        <li><a href="service-details-2-light.html">Kiểm soát ra vào & an ninh</a></li>
                        <li><a href="career-light.html">Đều khiển phòng khách sạn</a></li>
                        <li><a href="career-details-light.html">Quản lý tòa nhà BMS</a></li>
                    </ul>
                </li>
                <li class="has-dropdown p-static is-active">
                    <a href="#">Đối tác</a>
                    <ul class="tp-submenu submenu">
                        <li><a href="portfolio-webgl-showcase.html">Lutron</a></li>
                        <li><a href="portfolio-coverflow-slider-light.html">ABB</a></li>
                        <li><a href="portfolio-creative-thumb-slider.html">Creative Thumb Slider</a></li>
                        <li><a href="portfolio-creative-skew-slider.html">Legrand intergrated system</a></li>
                        <li><a href="portfolio-creative-text-slider.html">Vantage controls</a></li>
                        <li><a href="portfolio-parallax-slider.html">CP Electronics</a></li>
                    </ul>
                </li>
                <li class="is-active">
                    <a href="#">Sản phẩm</a>
                ...
                <li class="has-dropdown is-active">
                    ...
                    <ul class="tp-submenu submenu">
                        <li><a href="index-shop-modern-light.html">Giới thiệu</a></li>
                        <li><a href="shop-details.html">Dịch vụ</a></li>
                        <li><a href="my-account.html">Liên hệ</a></li>
                        <li><a href="cart.html">FAQ's</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
            ...
            <main>
                                ...
                                <div class="col-xl-11">
                                    <div class="ar-hero-title-box text-center tp_fade_anim" data-delay=".3">
                                        <h1 class="ar-hero-title mb-15">
                                            Giải pháp điều khiển & quản lý cho các công trình thương mại và khách sạn<br>
                                           <span class="subh1"> Tối ưu chiếu sáng, HVAC, Rèm Cửa, năng lượng & BMS Với Công Nghệ Từ ABB, Legrand...</span>
                                            
                                        </h1>   
                                    </div>
                                    <div class="ar-hero-btn text-center tp_fade_anim" data-delay=".5" data-fade-from="top" data-ease="bounce">
                                        <a class="tp-btn-black-solid" href="contact.html">Showcase the best Deals</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="ar-banner-area">
                    <div class="ar-banner-wrap">
                        <img class="w-100" src="{{ asset('assets/img/home-08/banner/banner.jpg') }}" alt="" data-speed=".8">
                    </div>
                            ...
                            <div class="row align-items-end">
                                <div class="col-xl-8 col-lg-8">
                                    <div class="ar-about-title-box">
                                        <span class="tp-section-subtitle-satisfy mb-20 tp_fade_anim" data-delay=".3">Agntix Office</span>
                                ...
                                <div class="col-xl-4 col-lg-4 d-none d-lg-block">
                                    <div class="ar-about-top-img text-end">
                                        <img data-speed=".9" src="{{ asset('assets/img/home-08/about/about-1.jpg') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row align-items-end">
                            <div class="col-xl-5 col-lg-5 col-md-7">
                                <div class="ar-about-thumb p-relative">
                                    <img data-speed=".8" src="{{ asset('assets/img/home-08/about/about-2.jpg') }}" alt="">
                                    <img class="ar-about-shape" src="{{ asset('assets/img/home-08/about/about-shape.png') }}" alt="">
                                </div>
                            </div>
                ...
                <div class="ar-service-area ar-service-height ar-service-mr p-relative fix">
                    <div class="ar-service-title-box">
                        <span class="tp-section-subtitle-satisfy text-white mb-20 tp_fade_anim" data-delay=".3">Architecture process</span>
                        <h3 class="tp-section-title-clash-600 text-white fs-60 mb-0 tp_fade_anim" data-delay=".4">The project <br> process.</h3>
                    </div>
                    <div class="ar-service-item d-flex align-items-end justify-content-end active">
                        <div class="ar-service-bg" data-background="assets/img/home-08/service/service-4.jpg"></div>
                        <span class="ar-service-title">Construction</span>
                    </div>
                    <div class="ar-service-item d-flex align-items-end justify-content-end">
                        <div class="ar-service-bg" data-background="assets/img/home-08/service/service-2.jpg"></div>
                        <span class="ar-service-title">City planning</span>
                    </div>
                    <div class="ar-service-item d-flex align-items-end justify-content-end">
                        <div class="ar-service-bg" data-background="assets/img/home-08/service/service-3.jpg"></div>
                        <span class="ar-service-title">Residential</span>
                    </div>
                    <div class="ar-service-item d-flex align-items-end justify-content-end">
                        <div class="ar-service-bg" data-background="assets/img/home-08/service/service-1.jpg"></div>
                        <span class="ar-service-title">Interior Design</span>
                    </div>
                </div>
                <!-- service area end -->
                            ...
                            <div class="row align-items-end">
                                <div class="col-xl-6 col-lg-8 col-md-7">
                                    <div class="ar-project-title-box">
                                        <span class="tp-section-subtitle-satisfy mb-20 tp_fade_anim" data-delay=".3">Latest Project</span>
                                        <h3 class="tp-section-title-clash-600 mb-0 tp_fade_anim" data-delay=".4">Selected <br> case studies</h3>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-4 col-md-5">
                                    <div class="ar-project-btn-box d-flex justify-content-md-end justify-content-start mb-15">
                                        <div class="tp-btn-red-circle-box tp_fade_anim" data-delay=".4" data-fade-from="top" data-ease="bounce">
                                            ...
                                            <a class="tp-btn-red-circle-text" href="portfolio-col-3-light.html">all projects</a>
                                            <a class="tp-btn-red-circle-icon" href="portfolio-col-3-light.html">
                                                <span>
                                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M1 11L11 1M11 1H1M11 1V11" stroke="currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <!-- funfact area start -->
                <div class="ar-funfact-area ar-funfact-bg mb-110" data-background="assets/img/home-08/hero/hero-bg-shape.png">
                    <div class="container container-1330">
                        <div class="row">
                            <div class="col-lg-3 col-md-4">
                                <div class="ar-funfact-item text-center mb-45 tp_fade_anim" data-delay=".3">
                                    <h4><i data-purecounter-duration="1" data-purecounter-end="4" class="purecounter">0</i>k+</h4>
                                    <span>Projects completed</span>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4">
                                <div class="ar-funfact-item text-center mb-45 tp_fade_anim" data-delay=".5">
                                    <h4><i data-purecounter-duration="1" data-purecounter-end="91" class="purecounter">0</i>+</h4>
                                    <span>renovation experts</span>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4">
                                <div class="ar-funfact-item text-center mb-45 tp_fade_anim" data-delay=".7">
                                    <h4><i data-purecounter-duration="1" data-purecounter-end="42" class="purecounter">0</i>+</h4>
                                    <span>renovation experts</span>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4">
                                <div class="ar-funfact-item text-center mb-45 tp_fade_anim" data-delay=".8">
                                    <h4><i data-purecounter-duration="1" data-purecounter-end="24" class="purecounter">0</i>+</h4>
                                    <span>Projects completed</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="ar-testimonial-area pb-200">
                    <div class="container container-1330">
                        <div class="row justify-content-center">
                            <div class="col-xl-8">
                                <div class="ar-testimonial-slider-wrap p-relative">
                                    <div class="ar-testimonial-shape-1">
                                        <img src="{{ asset('assets/img/home-08/testimonial/test-bg-1.png') }}" alt="">
                                    </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="ar-testimonial-item text-center">
                                                    <p>
                                                        agntix began as a collaborative <br> architectural and landscape workshop,
                                                        and <br> has remained true to its trans disciplinary way <br> of thinking since
                                                        its inception
                                                    </p>
                                                </div>
                                            </div>
                ...
                <div class="crp-text-slider-wrap p-relative">
                    <div class="crp-text-shape-wrap app">
                        <img class="crp-text-shape-1" src="{{ asset('assets/img/home-08/step/text-slide-2.png') }}" alt="">
                        <img class="crp-text-shape-2" src="{{ asset('assets/img/home-09/text-slider/text-slider-shape-1.png') }}" alt="">
                    </div>
                    <div class="swiper-container app-text-slider-color crp-text-slider-active">
                        <div class="swiper-wrapper slide-transtion">
                            <div class="swiper-slide">
                                <div class="crp-text-slider-item stroke-text">
                                    <span>we love</span>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="crp-text-slider-item">
                ...
                <!-- step area start -->
                <div class="ar-step-area ar-step-bg z-index-1" data-background="assets/img/home-08/step/step-bg.jpg">
                            ...
                            <div class="col-xxl-6 col-xl-5">
                                <div class="ar-step-title-box">
                                    <span class="tp-section-subtitle-satisfy text-white mb-20 tp_fade_anim" data-delay=".3">Architecture
                                        process</span>
                                    <h3 class="tp-section-title-clash-600 text-white mb-0 tp_fade_anim" data-delay=".4">The project process.</h3>
                                </div>
                            </div>
                            <div class="col-xxl-6 col-xl-7">
                                <div class="ar-step-right-wrap">
                                    <div class="row gx-0">
                                        <div class="col-md-6">
                                            <div class="ar-step-item">
                                                <div class="ar-step-top d-flex justify-content-between align-items-center">
                                                    <span class="ar-step-icon">
                                                        <svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M1.24121 5.44482L9.06772 9.97218L16.8942 5.44482M9.06836 19V9.96316M17.1371 13.5493V6.3772C17.1368 6.06278 17.0538 5.75396 16.8964 5.48174C16.7391 5.20952 16.5129 4.98346 16.2406 4.82625L9.96507 1.24022C9.6925 1.08285 9.3833 1 9.06856 1C8.75382 1 8.44463 1.08285 8.17206 1.24022L1.89651 4.82625C1.6242 4.98346 1.39803 5.20952 1.24068 5.48174C1.08332 5.75396 1.00032 6.06278 1 6.3772V13.5493C1.00032 13.8637 1.08332 14.1725 1.24068 14.4447C1.39803 14.7169 1.6242 14.943 1.89651 15.1002L8.17206 18.6862C8.44463 18.8436 8.75382 18.9265 9.06856 18.9265C9.3833 18.9265 9.6925 18.8436 9.96507 18.6862L16.2406 15.1002C16.5129 14.943 16.7391 14.7169 16.8964 14.4447C17.0538 14.1725 17.1368 13.8637 17.1371 13.5493Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                    </span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="ar-step-item">
                                                <div class="ar-step-top d-flex justify-content-between align-items-center">
                                                    <span class="ar-step-icon">
                                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M20.2149 14.8932C19.5786 16.3981 18.5833 17.7241 17.3161 18.7554C16.0489 19.7868 14.5484 20.492 12.9456 20.8094C11.3429 21.1268 9.68686 21.0468 8.12222 20.5764C6.55758 20.1059 5.132 19.2593 3.97012 18.1106C2.80824 16.962 1.94544 15.5461 1.45715 13.987C0.968852 12.4278 0.869934 10.7728 1.16904 9.16654C1.46815 7.56032 2.15617 6.05181 3.17296 4.77291C4.18975 3.49402 5.50434 2.48367 7.00181 1.8302" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M21.005 11.0023C21.005 9.6888 20.7463 8.38814 20.2436 7.1746C19.741 5.96106 19.0042 4.85842 18.0754 3.92961C17.1466 3.00081 16.044 2.26405 14.8304 1.76138C13.6169 1.25872 12.3162 1 11.0027 1V11.0023H21.005Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                        ...
                                        <div class="col-md-6">
                                            <div class="ar-step-item">
                                                <div class="ar-step-top d-flex justify-content-between align-items-center">
                                                    <span class="ar-step-icon">
                                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M10 1L1 5.5L10 10L19 5.5L10 1Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M1 14.5L10 19L19 14.5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M1 10L10 14.5L19 10" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                    </span>
                ...
                <div class="ar-brand-area ar-brand-style">
                    <div class="tp-brand-wrapper red-bg z-index-1">
                            ...
                            <div class="row">
                                <div class="col-xl-8">
                                    <div class="ar-award-title-box mb-50">
                                        ...
                                        <h3 class="tp-section-title-clash-600 fs-60 mb-0 tp_fade_anim" data-delay=".4">Awards & recognition</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row align-items-end">
                                <div class="col-xl-8 col-lg-8 col-md-7">
                                    <div class="ar-blog-title-box">
                                        <span class="tp-section-subtitle-satisfy mb-20 tp_fade_anim" data-delay=".3">Latesrt Articles</span>
                                        <h3 class="tp-section-title-clash-600 fs-60 mb-0 tp_fade_anim" data-delay=".4">RECENT BLOG POSTS</h3>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-5">
                                    <div class="ar-blog-btn-box d-flex justify-content-md-end justify-content-start mb-15">
                                        <div class="tp-btn-red-circle-box tp_fade_anim" data-delay=".5" data-fade-from="top" data-ease="bounce">
                                            ...
                                            <a class="tp-btn-red-circle-text" href="blog-grid-light.html">View all blog</a>
                                            <a class="tp-btn-red-circle-icon" href="blog-grid-light.html">
                                                <span>
                                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M1 11L11 1M11 1H1M11 1V11" stroke="currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-md-8">
                                <div class="ar-footer-widget ar-footer-col-1 mb-40 tp_fade_anim" data-delay=".3">
                                    <div class="ar-footer-logo mb-30">
                                        <a href="index.html"><img data-width="140" src="{{ asset('assets/img/logo/logo-white.png') }}" alt=""></a>
                                    </div>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-4">
                                <div class="ar-footer-widget ar-footer-col-2 mb-40 tp_fade_anim" data-delay=".4">
                                    <h4 class="ar-footer-widget-title">Company</h4>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4">
                                <div class="ar-footer-widget ar-footer-col-3 mb-40 tp_fade_anim" data-delay=".5">
                                    <h4 class="ar-footer-widget-title">Service</h4>
                                    <div class="ar-footer-widget-menu">
                                        <ul>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-5">
                                <div class="ar-footer-widget ar-footer-col-4 mb-40 tp_fade_anim" data-delay=".6">
                                    <h4 class="ar-footer-widget-title">Inquire</h4>
                                    <div class="ar-footer-widget-info-box">
                                        ...
                                        <div class="ar-footer-widget-info">
                                            <a class="" target="_blank" href="tel:(+068)56819696">(+068) 5681 96 96</a>
                                            <a class="" target="_blank" href="mailto:hello@agncy.com">hello@agncy.com</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="ar-copyright-text text-lg-start text-center">
                                    <p>ThemePure © 2025. All rights reserved.</p>
                                </div>
                            </div>
                            <div class="col-lg-6">
