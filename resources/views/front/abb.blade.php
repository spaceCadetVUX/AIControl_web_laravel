                            ...
                            <div class="col-lg-6">
                                <div class="tp-team-details-wrapper">
                                    <div class="tp-team-details-text">
                                        <h1 class="tp-team-details-text-title">ABB</h1>
                                    ...
                                    <div class="tp-team-details-more mb-50">
                                        <h3 class="tp-team-details-more-title">Ưu điểm vượt trội</h3>
                                        <ul>
                                    ...
                                    <div class="tp-team-details-more mb-50">
                                        <h3 class="tp-team-details-more-title">Ứng dụng ABB trong các công trình</h3>
                                        <ul>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-5">
                                                    <div class="dgm-service-content-left black-text d-inline-flex align-items-center">
                                                        <span class="">01</span>
                                                        <h3 class="dgm-service-title-sm "><a href="{{ route('lightingControl') }}">Chiếu sáng<br>Thông minh</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
