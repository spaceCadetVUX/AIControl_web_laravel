        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('admin.projects.store') }}" enctype="multipart/form-data" id="projectForm">
                ...
                <div class="bg-white shadow-sm rounded-lg mb-4">
                    <div class="border-b border-gray-200">
                        <nav class="flex -mb-px">
                            ...
                            <button type="button" onclick="showTab('categories')" id="tab-categories" class="tab-button border-b-2 border-transparent py-4 px-6 text-sm font-medium text-gray-500 hover:text-gray-700">
                                Danh mục
                            </button>
                            <button type="button" onclick="showTab('images')" id="tab-images" class="tab-button border-b-2 border-transparent py-4 px-6 text-sm font-medium text-gray-500 hover:text-gray-700">
                                Hình ảnh
                            </button>
                            <button type="button" onclick="showTab('details')" id="tab-details" class="tab-button border-b-2 border-transparent py-4 px-6 text-sm font-medium text-gray-500 hover:text-gray-700">
                                Chi tiết dự án
                            </button>
                            <button type="button" onclick="showTab('overview')" id="tab-overview" class="tab-button border-b-2 border-transparent py-4 px-6 text-sm font-medium text-gray-500 hover:text-gray-700">
                                Tổng quan
                            </button>
                            <button type="button" onclick="showTab('slider')" id="tab-slider" class="tab-button border-b-2 border-transparent py-4 px-6 text-sm font-medium text-gray-500 hover:text-gray-700">
                                Slider & Steps
                            </button>
                ...
                <div id="content-basic" class="tab-content bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="title" id="project-title" value="{{ old('title') }}" required 
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            @error('title') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Slug <span class="text-gray-500">(tự động tạo)</span></label>
                            <input type="text" name="slug" id="project-slug" value="{{ old('slug') }}" 
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <textarea name="short_description" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('short_description') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex items-center mt-6">
                                ...
                                <label for="featured" class="ml-2 block text-sm text-gray-900">Dự án nổi bật</label>
                            </div>
                        </div>
                ...
                <div id="content-categories" class="tab-content hidden bg-white shadow-sm rounded-lg p-6">
                    <h3 class="text-lg font-semibold mb-4">Danh mục dự án</h3>
                    
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Danh mục chính</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Danh mục phụ (tùy chọn)</label>
                            <select name="project_category_id_2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" {{ old('project_category_id_2') == $category->id ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div id="content-images" class="tab-content hidden bg-white shadow-sm rounded-lg p-6">
                    <h3 class="text-lg font-semibold mb-4">Hình ảnh dự án</h3>
                    
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Banner chính</label>
                            <input type="file" name="banner_image" accept="image/*" 
                                class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                            <p class="mt-1 text-xs text-gray-500">Kích thước đề nghị: 1920x800px</p>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="file" name="thumbnail_image" accept="image/*"
                                class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                            <p class="mt-1 text-xs text-gray-500">Kích thước đề nghị: 600x400px</p>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Gallery 1</label>
                                <input type="file" name="gallery_image_1" accept="image/*"
                                    class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Gallery 2</label>
                                <input type="file" name="gallery_image_2" accept="image/*"
                                    class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Gallery 3</label>
                ...
                <div id="content-details" class="tab-content hidden bg-white shadow-sm rounded-lg p-6">
                    <h3 class="text-lg font-semibold mb-4">Chi tiết dự án (4 cặp Title/Value)</h3>
                    
                    <div class="space-y-6">
                        @for($i = 1; $i <= 4; $i++)
                            <div class="border rounded-lg p-4">
                                <h4 class="font-medium text-gray-700 mb-3">Chi tiết {{ $i }}</h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Tiêu đề</label>
                                        <input type="text" name="detail_{{ $i }}_title" value="{{ old('detail_' . $i . '_title') }}" placeholder="Ví dụ: Khách hàng"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Giá trị</label>
                                        <input type="text" name="detail_{{ $i }}_value" value="{{ old('detail_' . $i . '_value') }}" placeholder="Ví dụ: Công ty ABC"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    </div>
                                </div>
                            </div>
                ...
                <div id="content-overview" class="tab-content hidden bg-white shadow-sm rounded-lg p-6">
                    <h3 class="text-lg font-semibold mb-4">Tổng quan dự án</h3>
                    
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Tiêu đề tổng quan</label>
                            <input type="text" name="overview_title" value="{{ old('overview_title') }}" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Nội dung tổng quan (Rich Text Editor)</label>
                            <textarea id="tinymce-overview" name="overview_content" rows="15">{{ old('overview_content') }}</textarea>
                ...
                <div id="content-slider" class="tab-content hidden bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Secondary Title -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Tiêu đề phụ</label>
                            <input type="text" name="secondary_title" value="{{ old('secondary_title') }}" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <div id="detail-steps-container" class="space-y-3">
                                <div class="flex items-start space-x-2 p-3 bg-gray-50 rounded">
                                    <div class="flex-1">
                                        <input type="text" name="detail_steps_title[]" placeholder="Tiêu đề bước" 
                                            class="mb-2 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                        <textarea name="detail_steps_description[]" rows="2" placeholder="Mô tả bước"
                                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"></textarea>
                                    </div>
                                    <button type="button" onclick="removeDetailStep(this)" class="px-3 py-2 bg-red-500 text-white rounded-md hover:bg-red-600">Xóa</button>
                                </div>
                            </div>
                            <button type="button" onclick="addDetailStep()" class="mt-2 px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600">+ Thêm bước</button>
                        </div>
                    </div>
                </div>
                ...
                <div id="content-seo" class="tab-content hidden bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="meta_title" id="meta-title-input" value="{{ old('meta_title') }}" maxlength="70"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                        ...
                        <div>
                            ...
                            <textarea name="meta_description" id="meta-desc-input" rows="3" maxlength="160"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Mô tả ngắn gọn về dự án, bao gồm các từ khóa quan trọng...">{{ old('meta_description') }}</textarea>
                ...
                <div class="bg-white shadow-sm rounded-lg p-6 mt-4">
                    <div class="flex items-center justify-end space-x-4">
                        <a href="{{ route('admin.projects') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400">
                            Hủy
                        </a>
    ...
    <script>
        ...
        function removeDetailStep(button) {
            if (document.querySelectorAll('#detail-steps-container > div').length > 1) {
                ...
                alert('Phải có ít nhất một bước');
            }
        }
