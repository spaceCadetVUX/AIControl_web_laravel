                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="text" id="logo_url" name="logo_url" value="{{ old('logo_url') }}" placeholder="assets/AIcontrol_imgs/ALLBrandImgs/your-logo.jpg" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <div id="logoPreview" class="mt-2">
                                @if(old('logo_url'))
                                    <img src="{{ str_starts_with(old('logo_url'), 'http') ? old('logo_url') : asset(old('logo_url')) }}" alt="Logo preview" class="h-16 w-auto rounded border">
                                @endif
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="url" name="website" value="{{ old('website') }}" placeholder="https://www.brand-website.com" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
...
<script>
    ...
    function handleBrandImageUpload() {
        ...
        // Allow SVG by extension if file.type may be empty or different in some browsers
