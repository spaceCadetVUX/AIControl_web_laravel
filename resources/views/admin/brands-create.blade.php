                ...
                <div class="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="url" name="logo_url" value="{{ old('logo_url') }}" placeholder="https://example.com/logo.png" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
