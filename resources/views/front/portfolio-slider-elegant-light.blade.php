...
<body class="tp-magic-cursor" data-bg-color="#fff">
            ...
            <div class="tp-offcanvas-2-left left-box">
                <div class="tp-offcanvas-2-left-wrap d-flex justify-content-between align-items-center">
                    <div class="tp-offcanvas-2-logo">
                        <a href="index.html">
                            <img class="logo-1" data-width="140" src="{{ asset('assets/img/logo/logo-white.png') }}" alt="">
                            <img class="logo-2" data-width="140" src="{{ asset('assets/img/logo/logo-black.png') }}" alt="">
                        </a>
                    </div>
            ...
            <div class="tp-offcanvas-2-right right-box d-none d-md-block p-relative">
                ...
                <div class="tp-offcanvas-2-right-info-box mt-160">
                    ...
                    <div class="tp-offcanvas-2-right-info-item">
                        ...
                        <a class="tp-line-white" href="tel:42345678910">+4 (234) 567 8910</a>
                    </div>
                    <div class="tp-offcanvas-2-right-info-item">
                        <label class="mb-10">Email</label>
                        <a class="tp-line-white" href="mailto:hello@gmail.com">hello@gmail.com</a>
                    </div>
                    <div class="tp-offcanvas-2-right-info-item">
                        ...
                        <div class="tp-offcanvas-2-right-social">
                            ...
                            <a href="#">
                                <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4.41177 0H0L5.23083 7.06953L0.334618 13H2.59681L6.29998 8.51461L9.58823 12.9588H14L8.6172 5.68381L8.62673 5.69636L13.2614 0.0825854H10.9992L7.55741 4.25145L4.41177 0ZM2.43522 1.2381H3.80866L11.5648 11.7206H10.1913L2.43522 1.2381Z" fill="currentcolor" />
                                </svg>
                            </a>
                            <a href="#">
    ...
    <!-- header area start -->
    <div class="tp-header-14-area header-fixed pt-10">
    ...
    <main>
        ...
        <div class="tp-slider-elegant-area pt-140 pb-120">
                    ...
                    <div class="tp-slider-elegant-item">
                        <div class="tp-slider-elegant-thumb not-hide-cursor" data-cursor="View<br>Demo">
                            <a class="cursor-hide" href="portfolio-details-gallery-light.html">
                                <img src="{{ asset('assets/img/project-slider-img/portfolio-slider-5/port-7.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="tp-slider-elegant-content">
                            <h4 class="tp-slider-elegant-title">
                                <a href="portfolio-details-gallery-light.html">Brand promotion</a>
                            </h4>
                        </div>
                    </div>
                    <div class="tp-slider-elegant-item">
                        <div class="tp-slider-elegant-thumb not-hide-cursor" data-cursor="View<br>Demo">
                            <a class="cursor-hide" href="portfolio-details-gallery-light.html">
                                <img src="{{ asset('assets/img/project-slider-img/portfolio-slider-5/port-6.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="tp-slider-elegant-content">
                            <h4 class="tp-slider-elegant-title">
                                <a href="portfolio-details-gallery-light.html">Commercial</a>
                            </h4>
                        </div>
                    </div>
                    <div class="tp-slider-elegant-item">
                        <div class="tp-slider-elegant-thumb not-hide-cursor" data-cursor="View<br>Demo">
                            <a class="cursor-hide" href="portfolio-details-gallery-light.html">
                                <img src="{{ asset('assets/img/project-slider-img/portfolio-slider-5/port-5.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="tp-slider-elegant-content">
                            <h4 class="tp-slider-elegant-title">
                                <a href="portfolio-details-gallery-light.html">Wedding</a>
                            </h4>
                        </div>
                    </div>
                    <div class="tp-slider-elegant-item">
                        <div class="tp-slider-elegant-thumb not-hide-cursor" data-cursor="View<br>Demo">
                            <a class="cursor-hide" href="portfolio-details-gallery-light.html">
                                <img src="{{ asset('assets/img/project-slider-img/portfolio-slider-5/port-4.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="tp-slider-elegant-content">
                            <h4 class="tp-slider-elegant-title">
                                <a href="portfolio-details-gallery-light.html">Portrait</a>
                            </h4>
                        </div>
                    </div>
                </div>
