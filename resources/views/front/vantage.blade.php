                                ...
                                <div class="col-xl-12">
                                    <div class="ar-hero-title-box tp_fade_anim" data-delay=".3">
                                        <div class="ar-about-us-4-title-box d-flex align-items-center mb-15">
                                            <span class="tp-section-subtitle pre tp_fade_anim">{{ __('vantage.hero_subtitle') }}</span>
                                        ...
                                        <h2 class="tp-career-title fs-50">{{ __('vantage.hero_title') }}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="tp-team-details-wrap">
                                    ...
                                    <div class="tp-team-details-info d-flex justify-content-between">
                                        <div class="tp-team-details-info-contact">
                                            <a href="tel:+84918918755" aria-label="{{ __('vantage.contact_phone_label') }} (+84) 0918 918 755">
                            ...
                            <div class="col-lg-6">
                                <div class="tp-team-details-wrapper">
                                    <div class="tp-team-details-text">
                                        <h1 class="tp-team-details-text-title">{{ __('vantage.overview_heading') }}</h1>
                                        <p>{{ __('vantage.overview_paragraph_1') }}</p>
                                        <p>{{ __('vantage.overview_paragraph_2') }}</p>
                                    </div>
                                    <div class="tp-team-details-more mb-50">
                                        <h3 class="tp-team-details-more-title">{{ __('vantage.advantages_title') }}</h3>
                                        <ul>
                                            @foreach(trans('vantage.advantages') as $adv)
                                                <li>{{ $adv }}</li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    <div class="tp-team-details-more mb-50">
                                        <h3 class="tp-team-details-more-title">{{ __('vantage.applications_title') }}</h3>
                                        <ul>
                                            @foreach(trans('vantage.applications') as $app)
                                                <li>{{ $app }}</li>
                                            @endforeach
                                        </ul>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-7">
                                    <div class="dgm-service-title-box service-4-heading z-index-1 mb-70">
                                        <span class="tp-section-subtitle subtitle-grey mb-15 text-black tp_fade_anim" data-delay=".3">{{ __('vantage.brand') }}</span>
                                        <h2 class="tp-section-title-grotesk text-black tp_fade_anim" data-delay=".5">
                                            {{ __('vantage.solutions_heading') }}
                                            <span class="p-relative">brand
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-5">
                                                    <div class="dgm-service-content-left black-text d-inline-flex align-items-center">
                                                        <span class="">01</span>
                                                        <h3 class="dgm-service-title-sm "><a href="{{ route(current_locale() . '.solution.lighting') }}">{{ __('vantage.Featured_1') }}</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="dgm-service-content-right black-text d-flex align-items-center justify-content-between">
                                                        <p>{{ __('vantage.Featured_1_desc') }}</p> 
                                        ...
                                        <div class="dgm-service-item p-relative tp_fade_anim">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-5">
                                                    <div class="dgm-service-content-left black-text d-inline-flex align-items-center">
                                                        <span>02</span>
                                                        <h3 class="dgm-service-title-sm"><a href="{{ route(current_locale() . '.solution.shade') }}">{{ __('vantage.Featured_2') }}</a></h3>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="dgm-service-content-right black-text d-flex align-items-center justify-content-between">
                                                        <p>{{ __('vantage.Featured_2_desc') }}</p>
                                                        <a class="dgm-service-link" href="{{ route(current_locale() . '.solution.shade') }}">
                                                            <span>
                                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M0.880859 13L12.8809 1M12.8809 1H0.880859M12.8809 1V13" stroke="currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                                </svg>
                ...
                <div class="ar-blog-area pb-100 pt-120">
                    <div class="container container-1430">
                            ...
                            <div class="row align-items-end">
                                <div class="col-xl-8 col-lg-8 col-md-7">
                                    <div class="ar-blog-title-box">
                                        <h3 class="tp-section-title-clash-600 fs-60 mb-0 tp_fade_anim" data-delay=".4">{{ __('vantage.latest_posts') }}</h3>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-5">
                                    <div class="ar-blog-btn-box d-flex justify-content-md-end justify-content-start mb-15">
                                        <div class="tp-btn-red-circle-box tp_fade_anim" data-delay=".5" data-fade-from="top" data-ease="bounce">
                                            ...
                                            <a class="tp-btn-red-circle-text" href="{{ route(current_locale() . '.blog.index') }}">{{ __('vantage.view_all_posts') }}</a>
                                            <a class="tp-btn-red-circle-icon" href="{{ route(current_locale() . '.blog.index') }}">
                                                <span>
                                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M1 11L11 1M11 1H1M11 1V11" stroke="currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <div class="row gx-40">
                            ...
                            @empty
                                <div class="col-12">
                                    <p class="text-center text-muted">{{ __('vantage.no_posts') }}</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
