...
<head>
    ...
    <title>Thương hiệu Vantage | Giải pháp điều khiển chiếu sáng cao cấp | AIControl Việt Nam</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta name="description" content="Vantage – thương hiệu thuộc tập đoàn Legrand, mang đến giải pháp điều khiển chiếu sáng và tự động hóa cao cấp cho biệt thự, resort, penthouse và không gian sang trọng. AIControl Việt Nam là đối tác chính thức của Vantage tại Việt Nam.">
    <meta name="keywords" content="Vantage, Legrand, Vantage Việt Nam, điều khiển chiếu sáng, lighting control, điều khiển thông minh, tự động hóa, nhà thông minh, biệt thự cao cấp, resort, AIControl, BMS, automation system">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <meta property="og:title" content="Thương hiệu Vantage | Giải pháp điều khiển chiếu sáng cao cấp | AIControl Việt Nam">
    <meta property="og:description" content="AIControl Việt Nam giới thiệu Vantage – thương hiệu Legrand chuyên về điều khiển chiếu sáng và tự động hóa dành cho không gian sang trọng và đòi hỏi thẩm mỹ cao.">
    <meta property="og:url" content="https://aicontrol.vn/vantage">
    <meta property="og:site_name" content="AIControl Việt Nam">
    <meta property="og:type" content="website">
    <meta property="og:image" content="https://aicontrol.vn/assets/img/seo/vantage-brand.jpg">
                                ...
                                <div class="col-xl-12">
                                    <div class="ar-hero-title-box tp_fade_anim" data-delay=".3">
                                        <div class="ar-about-us-4-title-box d-flex align-items-center mb-15">
                                            <span class="tp-section-subtitle pre tp_fade_anim">Vantage detalis</span>
                                        ...
                                        <h3 class="tp-career-title fs-50">Thông tin hãng</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="tp-team-details-wrap">
                                    <div class="tp-team-details-thumb mb-40">
                                        <img src="{{ assets('assets/AIcontrol_imgs/Partners/vantage/vantageBanner.png') }}" alt="">
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="tp-team-details-wrapper">
                                    <div class="tp-team-details-text">
                                        <h1 class="tp-team-details-text-title">Vantage</h1>
                                        <p>Cung cấp hệ thống điều khiển chiếu sáng cao cấp, tối ưu cho biệt thự, resort, và các không gian sang trọng</p>
                                        <p>Vantage là thương hiệu thuộc tập đoàn Legrand, nổi bật với các giải pháp điều khiển chiếu sáng và tự động hóa dành riêng cho biệt thự cao cấp, resort, penthouse, art gallery, và các không gian đòi hỏi độ tinh chỉnh cao về thẩm mỹ và kỹ thuật.</p>
                                    </div>
                                    <div class="tp-team-details-more mb-50">
                                        <h4 class="tp-team-details-more-title">Ưu điểm vượt trội Vantage</h4>
                                        <ul>
                                            <li>Giải pháp chiếu sáng cao cấp cho biệt thự, resort và không gian sang trọng</li>
                                            <li>Tùy biến linh hoạt, tạo kịch bản chiếu sáng tinh tế</li>
                                            <li>Tích hợp dễ dàng với rèm, âm thanh, HVAC và hệ thống Legrand</li>
                                            <li>Giao diện trực quan, hiệu suất ổn định và chính xác</li>
                                        </ul>
                                    </div>
                                    <div class="tp-team-details-more mb-50">
                                        <h4 class="tp-team-details-more-title">Ứng dụng Vantage trong các công trình</h4>
                                        <ul>
                                            <li>Biệt thự, penthouse cao cấp</li>
                                            <li>Resort, khách sạn 5 sao</li>
                                            <li>Phòng trưng bày nghệ thuật, showroom cao cấp</li>
                                            <li>Không gian thương mại sang trọng và nhà mẫu</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-5">
                                                    <div class="dgm-service-content-left black-text d-inline-flex align-items-center">
                                                        <span class="">01</span>
                                                        <h4 class="dgm-service-title-sm "><a href="service-details-light.html">Điều khiển<br>Chiếu sáng</a>
                                                        </h4>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="dgm-service-content-right black-text d-flex align-items-center justify-content-between">
                                                        <p>cho phép thiết lập không khí, làm nổi bật nghệ thuật và kiến trúc, mô phỏng ánh sáng tự nhiên chỉ với một cú chạm,...</p> 
                                        ...
                                        <div class="dgm-service-item p-relative tp_fade_anim">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-5">
                                                    <div class="dgm-service-content-left black-text d-inline-flex align-items-center">
                                                        <span>02</span>
                                                        <h4 class="dgm-service-title-sm"><a href="service-details-light.html">Điều khiển<br>Rèm tự động</a></h4>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="dgm-service-content-right black-text d-flex align-items-center justify-content-between">
                                                        <p>T Rèm hoạt động mượt mà, đáng tin cậy và hòa quyện hoàn hảo vào mọi không gian nội thất.</p>
                                                        <a class="dgm-service-link" href="service-details-light.html">
                                                            <span>
                                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M0.880859 13L12.8809 1M12.8809 1H0.880859M12.8809 1V13" stroke="currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
