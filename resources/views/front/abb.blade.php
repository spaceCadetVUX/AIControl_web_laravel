...
<head>
    ...
    <base href="{{ url('/') }}/">
    <title>{{ __('abb.meta_title') }}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta name="description" content="{{ __('abb.meta_description') }}">
    <meta name="keywords" content="{{ __('abb.meta_keywords') }}">
    <meta name="viewport" content="width=device-width, initial-scale=1">
                                ...
                                <div class="col-xl-12">
                                    <div class="ar-hero-title-box tp_fade_anim" data-delay=".3">
                                        <div class="ar-about-us-4-title-box d-flex align-items-center mb-15">
                                            <span class="tp-section-subtitle pre tp_fade_anim">{{ __('abb.hero_subtitle') }}</span>
                                        ...
                                        <h2 class="tp-career-title fs-70">{{ __('abb.hero_title') }}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="tp-team-details-wrapper">
                                    <div class="tp-team-details-text">
                                        <h1 class="tp-team-details-text-title">{{ __('abb.title') }}</h1>
                                        <p>{{ __('abb.description_1') }}</p>
                                        <p>{{ __('abb.description_2') }}</p>
                                    </div>
                                    <div class="tp-team-details-more mb-50">
                                        <h3 class="tp-team-details-more-title">{{ __('abb.advantages_title') }}</h3>
                                        <ul>
                                            <li>{{ __('abb.advantage_1') }}</li>
                                            <li>{{ __('abb.advantage_2') }}</li>
                                            <li>{{ __('abb.advantage_3') }}</li>
                                        </ul>
                                    </div>
                                    <div class="tp-team-details-more mb-50">
                                        <h3 class="tp-team-details-more-title">{{ __('abb.applications_title') }}</h3>
                                        <ul>
                                            <li>{{ __('abb.application_1') }}</li>
                                            <li>{{ __('abb.application_2') }}</li>
                                            <li>{{ __('abb.application_3') }}</li>
                                            <li>{{ __('abb.application_4') }}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-7">
                                    <div class="dgm-service-title-box service-4-heading z-index-1 mb-70">
                                        <span class="tp-section-subtitle subtitle-grey mb-15 text-black tp_fade_anim" data-delay=".3">{{ __('abb.solutions_section_subtitle') }}</span>
                                        <h2 class="tp-section-title-grotesk text-black tp_fade_anim" data-delay=".5">
                                            {{ __('abb.solutions_section_title') }}
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-5">
                                                    <div class="dgm-service-content-left black-text d-inline-flex align-items-center">
                                                        <span class="">01</span>
                                                        <h3 class="dgm-service-title-sm "><a href="{{ route('lightingControl') }}">{{ __('abb.solution_1_title') }}</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="dgm-service-content-right black-text d-flex align-items-center justify-content-between">
                                                        <p>{{ __('abb.solution_1_description') }}</p> 
                                        ...
                                        <div class="dgm-service-item p-relative tp_fade_anim">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-5">
                                                    <div class="dgm-service-content-left black-text d-inline-flex align-items-center">
                                                        <span>02</span>
                                                        <h3 class="dgm-service-title-sm"><a href="{{ route('hvacControl') }}">{{ __('abb.solution_2_title') }}</a></h3>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="dgm-service-content-right black-text d-flex align-items-center justify-content-between">
                                                        <p>{{ __('abb.solution_2_description') }}</p>
                                        ...
                                        <div class="dgm-service-item p-relative tp_fade_anim">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-5">
                                                    <div class="dgm-service-content-left black-text d-inline-flex align-items-center">
                                                        <span>04</span>
                                                        <h3 class="dgm-service-title-sm"><a href="{{ route('security') }}">{{ __('abb.solution_4_title') }}</a></h3>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="dgm-service-content-right black-text d-flex align-items-center justify-content-between">
                                                        <p>{{ __('abb.solution_4_description') }}</p>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-5">
                                    <div class="ar-blog-btn-box d-flex justify-content-md-end justify-content-start mb-15">
                                        <div class="tp-btn-red-circle-box tp_fade_anim" data-delay=".5" data-fade-from="top" data-ease="bounce">
                                            ...
                                            <a class="tp-btn-red-circle-text" href="{{ route('blog.index') }}">{{ __('abb.blog_view_all') }}</a>
                                            <a class="tp-btn-red-circle-icon" href="{{ route('blog.index') }}">
                                                <span>
                                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M1 11L11 1M11 1H1M11 1V11" stroke="currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
